...
for m in range(3000):
    ...
    yaw_1.append(agent_state[0][2])
    yaw_2.append(agent_state[1][2])
...
plt.plot(mlst,yaw_1,label='bot_1_yaw')
plt.plot(mlst,yaw_2,label='bot_2_yaw')
plt.plot(mlst,yaw_3,label='bot_3_yaw')
plt.plot(mlst,yaw_4,label='bot_4_yaw')
